...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_ORDER_STATUS_DAY_V1_Source_Only(ALLIVET_ORDER_NBR_V1_Source_Only STRING,
RX_HOLD_DT DATE,
OPEN_DT DATE,
COMPLETE_DT DATE,
VOID_DT DATE,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_ORDER_DAY_V1(ALLIVET_ORDER_NBR STRING,
