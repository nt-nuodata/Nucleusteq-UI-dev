...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_STATUS_DAY_V1_Source_Only_0


df_0 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR_V1_Source_Only AS ALLIVET_ORDER_NBR_V1_Source_Only,
...
FROM
  ALLIVET_ORDER_STATUS_DAY_V1_Source_Only""")

df_0.createOrReplaceTempView("Shortcut_to_ALLIVET_ORDER_STATUS_DAY_V1_Source_Only_0")
...
df_1 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR_V1_Source_Only AS ALLIVET_ORDER_NBR,
  RX_HOLD_DT AS RX_HOLD_DT,
  OPEN_DT AS OPEN_DT,
  COMPLETE_DT AS COMPLETE_DT,
  VOID_DT AS VOID_DT,
...
FROM
  Shortcut_to_ALLIVET_ORDER_STATUS_DAY_V1_Source_Only_0""")

df_1.createOrReplaceTempView("SQ_Shortcut_to_ALLIVET_ORDER_STATUS_DAY_1")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_DAY_V1_2
...
df_2 = spark.sql("""SELECT
  ...
  LOAD_TSTMP AS LOAD_TSTMP
FROM
  ALLIVET_ORDER_DAY_V1""")

df_2.createOrReplaceTempView("Shortcut_to_ALLIVET_ORDER_DAY_V1_2")
...
df_3 = spark.sql("""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_ALLIVET_ORDER_DAY_V1_2
WHERE
  (
