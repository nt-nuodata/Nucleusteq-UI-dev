...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_STATUS_DAY_v2_0


df_0 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR_v2 AS ALLIVET_ORDER_NBR_v2,
  RX_HOLD_DT AS RX_HOLD_DT,
  OPEN_DT_v2 AS OPEN_DT_v2,
  COMPLETE_DT AS COMPLETE_DT,
  VOID_DT_v2 AS VOID_DT_v2,
  UPDATE_TSTMP AS UPDATE_TSTMP,
  LOAD_TSTMP_v2 AS LOAD_TSTMP_v2
FROM
  ALLIVET_ORDER_STATUS_DAY_v2""")

df_0.createOrReplaceTempView("Shortcut_to_ALLIVET_ORDER_STATUS_DAY_v2_0")
...
df_1 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR_v2 AS ALLIVET_ORDER_NBR,
  RX_HOLD_DT AS RX_HOLD_DT,
  OPEN_DT_v2 AS OPEN_DT,
  COMPLETE_DT AS COMPLETE_DT,
  VOID_DT_v2 AS VOID_DT,
  UPDATE_TSTMP AS UPDATE_TSTMP,
  LOAD_TSTMP_v2 AS LOAD_TSTMP,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_ALLIVET_ORDER_STATUS_DAY_v2_0""")
...
# COMMAND ----------
# DBTITLE 1, ALLIVET_ORDER_STATUS_DAY_v2


spark.sql("""MERGE INTO ALLIVET_ORDER_STATUS_DAY_v2 AS TARGET
USING
  UPDTRANS_18 AS SOURCE ON TARGET.ALLIVET_ORDER_NBR_v2 = SOURCE.ALLIVET_ORDER_NBR
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_UPDATE" THEN
UPDATE
SET
  TARGET.ALLIVET_ORDER_NBR_v2 = SOURCE.ALLIVET_ORDER_NBR,
  TARGET.RX_HOLD_DT = SOURCE.o_RX_HOLD_DT,
  TARGET.OPEN_DT_v2 = SOURCE.o_OPEN_DT,
  TARGET.COMPLETE_DT = SOURCE.o_COMPLETE_DT,
  TARGET.VOID_DT_v2 = SOURCE.o_VOID_DT,
  TARGET.UPDATE_TSTMP = SOURCE.UPDATE_TSTMP,
  TARGET.LOAD_TSTMP_v2 = SOURCE.LOAD_TSTMP
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_DELETE"
  AND TARGET.RX_HOLD_DT = SOURCE.o_RX_HOLD_DT
  AND TARGET.OPEN_DT_v2 = SOURCE.o_OPEN_DT
  AND TARGET.COMPLETE_DT = SOURCE.o_COMPLETE_DT
  AND TARGET.VOID_DT_v2 = SOURCE.o_VOID_DT
  AND TARGET.UPDATE_TSTMP = SOURCE.UPDATE_TSTMP
  AND TARGET.LOAD_TSTMP_v2 = SOURCE.LOAD_TSTMP THEN DELETE
  WHEN NOT MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_INSERT" THEN
INSERT
  (
    TARGET.ALLIVET_ORDER_NBR_v2,
    TARGET.RX_HOLD_DT,
    TARGET.OPEN_DT_v2,
    TARGET.COMPLETE_DT,
    TARGET.VOID_DT_v2,
    TARGET.UPDATE_TSTMP,
    TARGET.LOAD_TSTMP_v2
  )
VALUES
  (
