...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.Allivet_Daily_Invoice_V1(InvoicePostingDate_V1 STRING,
InvoiceCode STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_DAILY_INVOICE_PRE_version_2(INVOICE_POSTING_DATE_v2 DATE,
INVOICE_CODE STRING,
