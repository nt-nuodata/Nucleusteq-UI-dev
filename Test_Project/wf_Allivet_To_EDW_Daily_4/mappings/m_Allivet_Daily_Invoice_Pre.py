...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_Allivet_Daily_Invoice_V1_0


df_0 = spark.sql("""SELECT
  InvoicePostingDate_V1 AS InvoicePostingDate_V1,
...
FROM
  Allivet_Daily_Invoice_V1""")

df_0.createOrReplaceTempView("Shortcut_to_Allivet_Daily_Invoice_V1_0")
...
df_1 = spark.sql("""SELECT
  InvoicePostingDate_V1 AS InvoicePostingDate,
  InvoiceCode AS InvoiceCode,
  TransactionType AS TransactionType,
  Allivet_Order AS Allivet_Order,
  PetSmart_Order AS PetSmart_Order,
...
FROM
  Shortcut_to_Allivet_Daily_Invoice_V1_0""")
...
# COMMAND ----------
# DBTITLE 1, ALLIVET_DAILY_INVOICE_PRE_version_2


spark.sql("""INSERT INTO
  ALLIVET_DAILY_INVOICE_PRE_version_2
SELECT
