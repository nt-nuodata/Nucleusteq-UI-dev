...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_DAILY_INVOICE_PRE_version_2_2
...
df_2.createOrReplaceTempView("Shortcut_to_ALLIVET_DAILY_INVOICE_PRE_version_2_2")
...
df_3 = spark.sql("""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_ALLIVET_DAILY_INVOICE_PRE_version_2_2""")
...
USING
  UPDTRANS_10 AS SOURCE ON TARGET.TXN_TYPE = SOURCE.TRANSACTION_TYPE
