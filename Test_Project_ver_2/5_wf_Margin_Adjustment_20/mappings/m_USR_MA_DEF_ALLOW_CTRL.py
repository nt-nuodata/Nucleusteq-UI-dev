...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_USR_MA_DEF_ALLOW_CTRL_0
...
df_0.createOrReplaceTempView("Shortcut_to_USR_MA_DEF_ALLOW_CTRL_0")
...
FROM
  Shortcut_to_USR_MA_DEF_ALLOW_CTRL_0""")
