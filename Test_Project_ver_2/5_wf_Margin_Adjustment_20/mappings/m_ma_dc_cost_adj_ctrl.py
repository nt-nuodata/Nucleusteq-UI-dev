...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_EVENT_TYPE_VAR_CTRL_0
...
df_0.createOrReplaceTempView("Shortcut_to_MA_EVENT_TYPE_VAR_CTRL_0")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_DC_COST_ADJ_CTRL_1
...
df_1.createOrReplaceTempView("Shortcut_to_MA_DC_COST_ADJ_CTRL_1")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_GL_ACCT_CTRL_2
...
df_2.createOrReplaceTempView("Shortcut_to_MA_GL_ACCT_CTRL_2")
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_EVENT_TYPE_4
...
df_4.createOrReplaceTempView("Shortcut_to_MA_EVENT_TYPE_4")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_EVENT_5
...
df_5.createOrReplaceTempView("Shortcut_to_MA_EVENT_5")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_SALES_TRANS_UPC_6
...
df_6.createOrReplaceTempView("Shortcut_to_MA_SALES_TRANS_UPC_6")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_GL_ACCOUNT_PROFILE_7
...
df_7.createOrReplaceTempView("Shortcut_to_GL_ACCOUNT_PROFILE_7")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_GL_PROFIT_CENTER_PROFILE_8
...
df_8.createOrReplaceTempView("Shortcut_to_GL_PROFIT_CENTER_PROFILE_8")
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SITE_PROFILE_RPT_10
...
df_10.createOrReplaceTempView("Shortcut_to_SITE_PROFILE_RPT_10")
...
df_11 = spark.sql("""SELECT
  ...
  A.MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
  A.EST_DC_COST_USD AS EST_DC_COST_USD,
  A.ACT_DC_COST_USD AS ACT_DC_COST_USD,
  A.DC_COST_ADJ_PCT AS DC_COST_ADJ_PCT,
  CURRENT_TIMESTAMP AS UPDATE_TSTMP,
  NVL(A.LOAD_TSTMP, CURRENT_TIMESTAMP) AS LOAD_TSTMP,
  CASE
...
FROM
  (
    SELECT
      ...
      B.ACT_DC_COST_USD,
      (
        (B.ACT_DC_COST_USD - A.EST_DC_COST_USD) / A.EST_DC_COST_USD
      ):: NUMERIC (12, 6) AS DC_COST_ADJ_PCT,
    ...
    FROM
      (
        SELECT
          ...
          - SUM(MSTU.MA_SALES_AMT * EXCH_RATE_PCT):: NUMERIC (12, 2) EST_DC_COST_USD
        FROM
          MA_SALES_TRANS_UPC MSTU
          JOIN Shortcut_to_MA_EVENT_5 ME ON MSTU.MA_EVENT_ID = ME.MA_EVENT_ID
          JOIN MA_FISCAL_MO_CTRL MFMC ON ME.FISCAL_MO = MFMC.FISCAL_MO
          AND MFMC.RESTATE_DT = CURRENT_DATE
          JOIN MA_EVENT_TYPE MET ON ME.MA_EVENT_TYPE_ID = MET.MA_EVENT_TYPE_ID
        WHERE
      ...
      JOIN (
        SELECT
          NVL(C.MA_EVENT_TYPE_ID, D.MA_EVENT_TYPE_ID) MA_EVENT_TYPE_ID,
          NVL(C.FISCAL_MO, D.FISCAL_MO) FISCAL_MO,
          NVL(C.ACT_DC_COST_USD, 0) + NVL(D.ACT_DC_COST_USD, 0) ACT_DC_COST_USD
        FROM
          (
            SELECT
              MET.MA_EVENT_TYPE_ID,
              GAD.FISCAL_MO,
              SUM(GAD.GL_GRP_AMT):: NUMERIC (12, 2) ACT_DC_COST_USD
            FROM
              GL_ACTUAL_DETAIL GAD
              JOIN GL_ACCOUNT_PROFILE GAP ON GAD.GL_ACCOUNT_GID = GAP.GL_ACCOUNT_GID
              LEFT JOIN DM_GL_COA DGC ON GAP.GL_ACCOUNT_NBR = DGC.GL_ACCT_NBR
              JOIN Shortcut_to_SITE_PROFILE_RPT_10 SITE ON GAD.LOCATION_ID = SITE.LOCATION_ID
              ...
              ) DCSLI ON MET.MA_EVENT_TYPE_ID = DCSLI.MA_EVENT_TYPE_ID
              AND DGC.STORE_LNBR:: VARCHAR (25) = DCSLI.MA_EVENT_TYPE_VAR_VALUE
              AND GAD.GL_POSTING_DT BETWEEN DCSLI.START_EFF_DT
              AND DCSLI.END_EFF_DT
              LEFT JOIN (
                SELECT
                  MA_EVENT_TYPE_ID,
                  MA_EVENT_TYPE_VAR_VALUE,
              ...
              ) DCGANE ON MET.MA_EVENT_TYPE_ID = DCGANE.MA_EVENT_TYPE_ID
              AND GAP.GL_ACCOUNT_NBR:: VARCHAR (25) = DCGANE.MA_EVENT_TYPE_VAR_VALUE
              AND GAD.GL_POSTING_DT BETWEEN DCGANE.START_EFF_DT
              AND DCGANE.END_EFF_DT
              LEFT JOIN (
                SELECT
                  MA_EVENT_TYPE_ID,
                  MA_EVENT_TYPE_VAR_VALUE,
              ...
              ) DCGANI ON MET.MA_EVENT_TYPE_ID = DCGANI.MA_EVENT_TYPE_ID
              AND GAP.GL_ACCOUNT_NBR:: VARCHAR (25) = DCGANI.MA_EVENT_TYPE_VAR_VALUE
              AND GAD.GL_POSTING_DT BETWEEN DCGANI.START_EFF_DT
              AND DCGANI.END_EFF_DT
              LEFT JOIN (
                SELECT
                  MA_EVENT_TYPE_ID,
                  CASE
                ...
                FROM
                  ...
                  JOIN SITE_PROFILE SITE ON METVC.MA_EVENT_TYPE_VAR_VALUE = SITE.LOCATION_TYPE_ID:: VARCHAR (25)
                WHERE
              ...
              ) LT ON MET.MA_EVENT_TYPE_ID = LT.MA_EVENT_TYPE_ID
              AND SUBSTR(GPCP.GL_PROFIT_CENTER_CD, 1, 7) = '0000003'
              AND SUBSTR(GPCP.GL_PROFIT_CENTER_CD, 9, 2) = LT.STORE_NBR
              AND GAD.GL_POSTING_DT BETWEEN LT.START_EFF_DT
              AND LT.END_EFF_DT
              LEFT JOIN (
                SELECT
                  MA_EVENT_TYPE_ID,
              ...
              ) LT2 ON MET.MA_EVENT_TYPE_ID = LT2.MA_EVENT_TYPE_ID
              AND SITE.LOCATION_TYPE_ID:: VARCHAR (25) = LT2.MA_EVENT_TYPE_VAR_VALUE
              AND GAD.GL_POSTING_DT BETWEEN LT2.START_EFF_DT
              AND LT2.END_EFF_DT
              LEFT JOIN (
                SELECT
                  MA_EVENT_TYPE_ID,
              ...
              ) GPC ON MET.MA_EVENT_TYPE_ID = GPC.MA_EVENT_TYPE_ID
              AND GPCP.GL_PROFIT_CENTER_CD:: VARCHAR (25) = GPC.MA_EVENT_TYPE_VAR_VALUE
              AND GAD.GL_POSTING_DT BETWEEN GPC.START_EFF_DT
              AND GPC.END_EFF_DT
            WHERE
          ...
          FULL OUTER JOIN (
            SELECT
              ...
              D.FISCAL_MO,
              M.MA_EVENT_TYPE_VAR_VALUE:: NUMERIC (12, 2) ACT_DC_COST_USD
            FROM
              MA_EVENT_TYPE_VAR_CTRL M
              JOIN DAYS D ON D.DAY_DT BETWEEN M.START_EFF_DT
              AND M.END_EFF_DT
              JOIN MA_FISCAL_MO_CTRL MFMC ON D.FISCAL_MO = MFMC.FISCAL_MO
              AND MFMC.RESTATE_DT = CURRENT_DATE
            WHERE
          ...
          ) D ON C.MA_EVENT_TYPE_ID = D.MA_EVENT_TYPE_ID
          AND C.FISCAL_MO = D.FISCAL_MO
      ) B ON A.REF_MA_EVENT_TYPE_ID = B.MA_EVENT_TYPE_ID
      AND A.FISCAL_MO = B.FISCAL_MO
  ) A
  LEFT JOIN Shortcut_to_MA_DC_COST_ADJ_CTRL_1 MDCAC ON A.MA_EVENT_TYPE_ID = MDCAC.MA_EVENT_TYPE_ID
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_GL_ACTUAL_DETAIL_13
...
df_13.createOrReplaceTempView("Shortcut_to_GL_ACTUAL_DETAIL_13")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_DM_GL_COA_14
...
df_14.createOrReplaceTempView("Shortcut_to_DM_GL_COA_14")

# COMMAND ----------
# DBTITLE 1, MA_DC_COST_ADJ_CTRL


spark.sql("""MERGE INTO MA_DC_COST_ADJ_CTRL AS TARGET
USING
  UPD_Strategy_12 AS SOURCE ON TARGET.MA_EVENT_TYPE_ID = SOURCE.MA_EVENT_TYPE_ID
...
SET
  ...
  TARGET.EST_DC_COST_USD = SOURCE.EST_DC_COST_USD,
  TARGET.ACT_DC_COST_USD = SOURCE.ACT_DC_COST_USD,
  TARGET.DC_COST_ADJ_PCT = SOURCE.DC_COST_ADJ_PCT,
  TARGET.UPDATE_TSTMP = SOURCE.UPDATE_TSTMP,
  TARGET.LOAD_TSTMP = SOURCE.LOAD_TSTMP
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_DELETE"
  AND TARGET.EST_DC_COST_USD = SOURCE.EST_DC_COST_USD
  AND TARGET.ACT_DC_COST_USD = SOURCE.ACT_DC_COST_USD
  AND TARGET.DC_COST_ADJ_PCT = SOURCE.DC_COST_ADJ_PCT
...
INSERT
  (
    ...
    TARGET.EST_DC_COST_USD,
    TARGET.ACT_DC_COST_USD,
    TARGET.DC_COST_ADJ_PCT,
    TARGET.UPDATE_TSTMP,
    TARGET.LOAD_TSTMP
  )
VALUES
  (
    ...
    SOURCE.EST_DC_COST_USD,
    SOURCE.ACT_DC_COST_USD,
    SOURCE.DC_COST_ADJ_PCT,
    SOURCE.UPDATE_TSTMP,
    SOURCE.LOAD_TSTMP
  )""")