...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_SALES_TRANS_UPC_0
...
df_0.createOrReplaceTempView("Shortcut_to_MA_SALES_TRANS_UPC_0")
...
df_2 = spark.sql("""SELECT
  ...
  'Shortcut_to_MA_SALES_TRANS_UPC_0' AS TABLE_NAME,
  COUNT(*) AS BEGIN_ROW_CNT,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_MA_SALES_TRANS_UPC_0""")
