...
# COMMAND ----------
# DBTITLE 1, ASQ_EM_EVENT_DETAIL_1
...
df_1.createOrReplaceTempView("ASQ_EM_EVENT_DETAIL_1")
...
SELECT
  ...
  NULL AS UPC_ID,
  NULL AS TP_INVOICE_NBR,
  NULL AS PARENT_UPC_ID,
  NULL AS COMBO_TYPE_CD,
  NULL AS POS_TXN_SEQ_NBR,
  NULL AS MA_EVENT_ID,
  NULL AS PRODUCT_ID,
  NULL AS SALES_CUST_CAPTURE_CD,
  NULL AS MA_SALES_AMT,
  NULL AS MA_SALES_QTY,
  NULL AS EXCH_RATE_PCT,
  NULL AS RESTATE_FLAG
FROM
  FIL_PASS_NO_ROW_2""")