...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_USR_MA_DC_COST_CTRL_0
...
df_0.createOrReplaceTempView("Shortcut_to_USR_MA_DC_COST_CTRL_0")
...
FROM
  Shortcut_to_USR_MA_DC_COST_CTRL_0""")
