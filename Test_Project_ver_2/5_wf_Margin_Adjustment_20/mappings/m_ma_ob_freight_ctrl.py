...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_GL_ACCT_CTRL_0
...
df_0.createOrReplaceTempView("Shortcut_to_MA_GL_ACCT_CTRL_0")

# COMMAND ----------
# DBTITLE 1, MA_OB_FREIGHT_CTRL1_1
...
df_1.createOrReplaceTempView("MA_OB_FREIGHT_CTRL1_1")

# COMMAND ----------
# DBTITLE 1, MA_OB_FREIGHT_CTRL_2
...
df_2.createOrReplaceTempView("MA_OB_FREIGHT_CTRL_2")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_FISCAL_MO_CTRL_3
...
df_3.createOrReplaceTempView("Shortcut_to_MA_FISCAL_MO_CTRL_3")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_EVENT_4
...
df_4.createOrReplaceTempView("Shortcut_to_MA_EVENT_4")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SUPPLY_CHAIN_5
...
df_5.createOrReplaceTempView("Shortcut_to_SUPPLY_CHAIN_5")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SUPPLY_CHAIN1_6
...
df_6.createOrReplaceTempView("Shortcut_to_SUPPLY_CHAIN1_6")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_SALES_TRANS_UPC_7
...
df_7.createOrReplaceTempView("Shortcut_to_MA_SALES_TRANS_UPC_7")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_GL_ACCOUNT_PROFILE_8
...
df_8.createOrReplaceTempView("Shortcut_to_GL_ACCOUNT_PROFILE_8")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_GL_PROFIT_CENTER_PROFILE_9
...
df_9.createOrReplaceTempView("Shortcut_to_GL_PROFIT_CENTER_PROFILE_9")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_DAYS1_10
...
df_10.createOrReplaceTempView("Shortcut_To_DAYS1_10")

# COMMAND ----------
# DBTITLE 1, SQ_MA_OB_FREIGHT_CTRL_UPD_11


df_11 = spark.sql("""SELECT
  SC.FROM_LOCATION_ID AS FROM_LOCATION_ID,
  SC.FISCAL_MO AS FISCAL_MO,
  SC.R12_NET_SALES_COST AS R12_NET_SALES_COST,
  SC.R12_OB_FREIGHT_COST AS R12_OB_FREIGHT_COST,
  SC.R12_OB_FREIGHT_PCT AS R12_OB_FREIGHT_PCT,
  SC.ACT_NET_SALES_COST AS ACT_NET_SALES_COST,
  NVL(GLA.ACT_OB_FREIGHT_COST, 0) AS ACT_OB_FREIGHT_COST,
  CASE
    WHEN SC.ACT_NET_SALES_COST = 0 THEN 0
    ELSE NVL(GLA.ACT_OB_FREIGHT_COST, 0) / SC.ACT_NET_SALES_COST
  END AS ACT_OB_FREIGHT_PCT,
  SC.UPDATE_TSTMP AS UPDATE_TSTMP,
...
FROM
  (
    SELECT
      ...
      ROUND(
        NVL(
          SUM(
            (STU.SALES_COST - STU.RETURN_COST) * STU.EXCH_RATE_PCT
          ),
          0
        ),
        2
    ...
    FROM
      MA_OB_FREIGHT_CTRL1_1 MOFC
      JOIN MA_EVENT ME ON MOFC.FROM_LOCATION_ID = ME.FROM_LOCATION_ID
      AND MOFC.FISCAL_MO = ME.FISCAL_MO
      AND ME.MA_EVENT_TYPE_ID = 70
      JOIN MA_SALES_TRANS_UPC MSTU ON ME.MA_EVENT_ID = MSTU.MA_EVENT_ID
      JOIN MA_FISCAL_MO_CTRL MFMC ON MOFC.FISCAL_MO = MFMC.FISCAL_MO
      AND MFMC.RESTATE_DT = CURRENT_DATE
      JOIN SALES_TRANS_UPC STU ON MSTU.DAY_DT = STU.DAY_DT
  ...
  LEFT JOIN (
    SELECT
      GAD.FISCAL_MO,
      CASE
        WHEN SITE.LOCATION_TYPE_ID IN (1, 3) THEN SITE.LOCATION_ID
        WHEN SUBSTR(GPCP.GL_PROFIT_CENTER_CD, 1, 8) = '00000039' THEN SITE2.LOCATION_ID
        ELSE 0
      END FROM_LOCATION_ID,
      SUM(GAD.GL_GRP_AMT) ACT_OB_FREIGHT_COST
    FROM
      GL_ACTUAL_DETAIL GAD
      JOIN GL_ACCOUNT_PROFILE GAP ON GAD.GL_ACCOUNT_GID = GAP.GL_ACCOUNT_GID
      JOIN GL_PROFIT_CENTER_PROFILE GPCP ON GAD.GL_PROFIT_CENTER_GID = GPCP.GL_PROFIT_CENTER_GID
      JOIN DM_GL_COA DGC ON GAP.GL_ACCOUNT_NBR = DGC.GL_ACCT_NBR
      JOIN SITE_PROFILE SITE ON GAD.LOCATION_ID = SITE.LOCATION_ID
      JOIN MA_FISCAL_MO_CTRL MFMC ON GAD.FISCAL_MO = MFMC.FISCAL_MO
      AND MFMC.RESTATE_DT = CURRENT_DATE
      JOIN (
        SELECT
      ...
      ) DCSLE ON DGC.STORE_LNBR:: VARCHAR (25) = DCSLE.MA_EVENT_TYPE_VAR_VALUE
      AND GAD.GL_POSTING_DT BETWEEN DCSLE.START_EFF_DT
      AND DCSLE.END_EFF_DT
      LEFT JOIN (
        SELECT
          LPAD(STORE_NBR, 2, '0') STORE_NBR,
          LOCATION_ID
        FROM
          SITE_PROFILE
        WHERE
          LOCATION_TYPE_ID IN (1, 3)
          AND LENGTH(STORE_NBR) <= 2
      ) SITE2 ON CASE
        WHEN SUBSTR(GPCP.GL_PROFIT_CENTER_CD, 1, 8) = '00000039' THEN SUBSTR(GPCP.GL_PROFIT_CENTER_CD, 9, 2)
      END = SITE2.STORE_NBR
    GROUP BY
      GAD.FISCAL_MO,
      CASE
        ...
        ELSE 0
      END
  ) GLA ON SC.FROM_LOCATION_ID = GLA.FROM_LOCATION_ID
  AND SC.FISCAL_MO = GLA.FISCAL_MO""")

df_11.createOrReplaceTempView("SQ_MA_OB_FREIGHT_CTRL_UPD_11")

# COMMAND ----------
# DBTITLE 1, EXP_UPDATE_12
...
df_12 = spark.sql("""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_MA_OB_FREIGHT_CTRL_UPD_11""")

df_12.createOrReplaceTempView("EXP_UPDATE_12")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_DAYS_13
...
df_13.createOrReplaceTempView("Shortcut_To_DAYS_13")

# COMMAND ----------
# DBTITLE 1, SQ_MA_OB_FREIGHT_CTRL_INS_14


df_14 = spark.sql("""SELECT
  A.FROM_LOCATION_ID AS FROM_LOCATION_ID,
  A.FISCAL_MO AS FISCAL_MO,
  NVL(LR.EST_NET_SALES_COST, WR.EST_NET_SALES_COST) AS R12_NET_SALES_COST,
  NVL(LR.EST_OB_FREIGHT_COST, WR.EST_OB_FREIGHT_COST) AS R12_OB_FREIGHT_COST,
  NVL(LR.EST_OB_FREIGHT_PCT, WR.EST_OB_FREIGHT_PCT) AS R12_OB_FREIGHT_PCT,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  (
    SELECT
      ...
      D.FISCAL_MO
    FROM
      Shortcut_to_SUPPLY_CHAIN_5 SC
      JOIN SITE_PROFILE SITE ON SC.FROM_LOCATION_ID = SITE.LOCATION_ID
      CROSS JOIN (
        SELECT
          DISTINCT FISCAL_MO
        FROM
          Shortcut_To_DAYS_13 D
        WHERE
          ...
          AND FISCAL_MO > (
            SELECT
              MAX(FISCAL_MO)
            FROM
              MA_OB_FREIGHT_CTRL_2
            WHERE
              ACT_NET_SALES_COST IS NOT NULL
          )
      ) D
    WHERE
      SITE.LOCATION_TYPE_ID IN (1, 3)
  ) A
  LEFT JOIN MA_OB_FREIGHT_CTRL_2 MOFC ON A.FROM_LOCATION_ID = MOFC.FROM_LOCATION_ID
  ...
  LEFT JOIN (
    ...
    HAVING
      FISCAL_MO_CNT >= 3
  ) LR ON A.FROM_LOCATION_ID = LR.FROM_LOCATION_ID
  CROSS JOIN (
    SELECT
      SUM(ACT_NET_SALES_COST) EST_NET_SALES_COST,
      SUM(ACT_OB_FREIGHT_COST) EST_OB_FREIGHT_COST,
...
df_14.createOrReplaceTempView("SQ_MA_OB_FREIGHT_CTRL_INS_14")

# COMMAND ----------
# DBTITLE 1, EXP_INSERT_15
...
df_15 = spark.sql("""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_MA_OB_FREIGHT_CTRL_INS_14""")

df_15.createOrReplaceTempView("EXP_INSERT_15")

# COMMAND ----------
# DBTITLE 1, UNI_OB_FREIGHT_16
...
df_16.createOrReplaceTempView("UNI_OB_FREIGHT_16")
...
# COMMAND ----------
# DBTITLE 1, Shortcut_To_SITE_PROFILE_18
...
df_18.createOrReplaceTempView("Shortcut_To_SITE_PROFILE_18")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_GL_ACTUAL_DETAIL_19
...
df_19.createOrReplaceTempView("Shortcut_to_GL_ACTUAL_DETAIL_19")

# COMMAND ----------
# DBTITLE 1, MA_OB_FREIGHT_CTRL


spark.sql("""MERGE INTO MA_OB_FREIGHT_CTRL AS TARGET
USING
  UPD_STRATEGY_17 AS SOURCE ON TARGET.FROM_LOCATION_ID = SOURCE.FROM_LOCATION_ID
...
SET
  ...
  TARGET.R12_NET_SALES_COST = SOURCE.R12_NET_SALES_COST,
  TARGET.R12_OB_FREIGHT_COST = SOURCE.R12_OB_FREIGHT_COST,
  TARGET.R12_OB_FREIGHT_PCT = SOURCE.R12_OB_FREIGHT_PCT,
  TARGET.ACT_NET_SALES_COST = SOURCE.ACT_NET_SALES_COST,
  TARGET.ACT_OB_FREIGHT_COST = SOURCE.ACT_OB_FREIGHT_COST,
  TARGET.ACT_OB_FREIGHT_PCT = SOURCE.ACT_OB_FREIGHT_PCT,
  TARGET.UPDATE_TSTMP = SOURCE.UPDATE_TSTMP,
  TARGET.LOAD_TSTMP = SOURCE.LOAD_TSTMP
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_DELETE"
  AND TARGET.R12_NET_SALES_COST = SOURCE.R12_NET_SALES_COST
  AND TARGET.R12_OB_FREIGHT_COST = SOURCE.R12_OB_FREIGHT_COST
  AND TARGET.R12_OB_FREIGHT_PCT = SOURCE.R12_OB_FREIGHT_PCT
  AND TARGET.ACT_NET_SALES_COST = SOURCE.ACT_NET_SALES_COST
  AND TARGET.ACT_OB_FREIGHT_COST = SOURCE.ACT_OB_FREIGHT_COST
  AND TARGET.ACT_OB_FREIGHT_PCT = SOURCE.ACT_OB_FREIGHT_PCT
...
INSERT
  (
    ...
    TARGET.FISCAL_MO,
    TARGET.R12_NET_SALES_COST,
    TARGET.R12_OB_FREIGHT_COST,
    TARGET.R12_OB_FREIGHT_PCT,
    TARGET.ACT_NET_SALES_COST,
    TARGET.ACT_OB_FREIGHT_COST,
    TARGET.ACT_OB_FREIGHT_PCT,
    TARGET.UPDATE_TSTMP,
    TARGET.LOAD_TSTMP
  )
VALUES
  (
    ...
    SOURCE.FISCAL_MO,
    SOURCE.R12_NET_SALES_COST,
    SOURCE.R12_OB_FREIGHT_COST,
    SOURCE.R12_OB_FREIGHT_PCT,
    SOURCE.ACT_NET_SALES_COST,
    SOURCE.ACT_OB_FREIGHT_COST,
    SOURCE.ACT_OB_FREIGHT_PCT,
    SOURCE.UPDATE_TSTMP,
    SOURCE.LOAD_TSTMP
  )""")