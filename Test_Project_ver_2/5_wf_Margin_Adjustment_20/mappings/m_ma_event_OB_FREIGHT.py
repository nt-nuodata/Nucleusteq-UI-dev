...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_OB_FREIGHT_CTRL1_1
...
df_1.createOrReplaceTempView("Shortcut_to_MA_OB_FREIGHT_CTRL1_1")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_OB_FREIGHT_CTRL_2
...
df_2.createOrReplaceTempView("Shortcut_to_MA_OB_FREIGHT_CTRL_2")
...
# COMMAND ----------
# DBTITLE 1, SQ_MA_OB_FREIGHT_CTRL_UPDATES_4
...
df_4 = spark.sql("""SELECT
  ...
  M.END_DT AS END_DT,
  70 AS MA_EVENT_TYPE_ID,
  12 AS MA_EVENT_SOURCE_ID,
  MOFC.FISCAL_MO AS FISCAL_MO,
  MOFC.FROM_LOCATION_ID AS FROM_LOCATION_ID,
  'Outbound Freight: DC=' || SITE.STORE_NBR:: VARCHAR (10) || '; FMth=' || MOFC.FISCAL_MO:: VARCHAR (10) AS MA_EVENT_DESC,
  1 AS MA_PCT_IND,
  NVL(MOFC.ACT_OB_FREIGHT_PCT, R12_OB_FREIGHT_PCT) * -100 AS NEW_MA_AMT,
  M.MA_AMT AS ORIG_MA_AMT,
  'U' AS INS_UPD_DEL_FLAG,
  M.LOAD_DT AS LOAD_DT,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_MA_OB_FREIGHT_CTRL1_1 MOFC
  JOIN SITE_PROFILE SITE ON MOFC.FROM_LOCATION_ID = SITE.LOCATION_ID
  JOIN Shortcut_to_MA_EVENT11_3 M ON MOFC.FISCAL_MO = M.FISCAL_MO
...
df_4.createOrReplaceTempView("SQ_MA_OB_FREIGHT_CTRL_UPDATES_4")

# COMMAND ----------
# DBTITLE 1, EXP_ORIG_5
...
df_5 = spark.sql("""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_MA_OB_FREIGHT_CTRL_UPDATES_4""")

df_5.createOrReplaceTempView("EXP_ORIG_5")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_EVENT1_6
...
df_6.createOrReplaceTempView("Shortcut_to_MA_EVENT1_6")
...
# COMMAND ----------
# DBTITLE 1, SQ_MA_OB_FREIGHT_CTRL_INSERTS_8
...
df_8 = spark.sql("""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_MA_OB_FREIGHT_CTRL_2 MOFC
  JOIN SITE_PROFILE SITE ON MOFC.FROM_LOCATION_ID = SITE.LOCATION_ID
  JOIN (
    SELECT
      FISCAL_MO,
    ...
    GROUP BY
      FISCAL_MO
  ) D ON MOFC.FISCAL_MO = D.FISCAL_MO
  LEFT JOIN Shortcut_to_MA_EVENT1_6 M ON MOFC.FISCAL_MO = M.FISCAL_MO
  AND MOFC.FROM_LOCATION_ID = M.FROM_LOCATION_ID
WHERE
...
df_8.createOrReplaceTempView("SQ_MA_OB_FREIGHT_CTRL_INSERTS_8")
...
df_9 = spark.sql("""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_MA_OB_FREIGHT_CTRL_INSERTS_8""")

df_9.createOrReplaceTempView("EXP_NEW_9")

spark.sql("""UPDATE SEQ_MA_EVENT_ID SET CURRVAL = (SELECT MAX(MA_EVENT_ID) FROM EXP_NEW_9) , NEXTVAL = (SELECT MAX(MA_EVENT_ID) FROM EXP_NEW_9) + (SELECT Increment_By FROM EXP_NEW_9)""")

# COMMAND ----------
# DBTITLE 1, UNI_NEW_ORIG_10
...
df_10.createOrReplaceTempView("UNI_NEW_ORIG_10")

# COMMAND ----------
# DBTITLE 1, UPD_STRATEGY_11
...
df_11.createOrReplaceTempView("UPD_STRATEGY_11")
...
USING
  UPD_STRATEGY_11 AS SOURCE ON TARGET.MA_EVENT_ID = SOURCE.MA_EVENT_ID
  WHEN MATCHED
...
SET
  ...
  AND TARGET.FROM_LOCATION_ID = SOURCE.FROM_LOCATION_ID
