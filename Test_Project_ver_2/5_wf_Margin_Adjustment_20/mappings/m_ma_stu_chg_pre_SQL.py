...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SQL_TRANSFORM_DUMMY_SOURCE_0
...
df_0.createOrReplaceTempView("Shortcut_to_SQL_TRANSFORM_DUMMY_SOURCE_0")
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_SALES_TRANS_UPC_8
...
df_8.createOrReplaceTempView("Shortcut_to_MA_SALES_TRANS_UPC_8")
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_MA_EVENT_RESTATE_HIST_10
...
df_10.createOrReplaceTempView("Shortcut_to_MA_EVENT_RESTATE_HIST_10")
