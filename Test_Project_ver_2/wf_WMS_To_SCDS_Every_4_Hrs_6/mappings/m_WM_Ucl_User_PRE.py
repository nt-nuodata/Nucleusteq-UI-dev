...
WHERE
  $$Initial_Load (
    trunc(UCL_USER.CREATED_DTTM) >= trunc(to_date('$$Prev_Run_Dt', 'MM/DD/YYYY HH24:MI:SS')) - 1
  )
  OR (
    trunc(UCL_USER.LAST_UPDATED_DTTM) >= trunc(to_date('$$Prev_Run_Dt', 'MM/DD/YYYY HH24:MI:SS')) - 1
  )
  AND 1 = 1""")
