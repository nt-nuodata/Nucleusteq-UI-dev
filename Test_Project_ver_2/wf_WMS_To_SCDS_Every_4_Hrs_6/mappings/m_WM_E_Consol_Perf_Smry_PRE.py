...
WHERE
  $$Initial_Load (
    trunc(E_CONSOL_PERF_SMRY.CREATE_DATE_TIME) >= trunc(to_date('$$Prev_Run_Dt', 'MM/DD/YYYY HH24:MI:SS')) - 1
  )
  OR (
    trunc(E_CONSOL_PERF_SMRY.MOD_DATE_TIME) >= trunc(to_date('$$Prev_Run_Dt', 'MM/DD/YYYY HH24:MI:SS')) - 1
  )
  AND 1 = 1""")
